...
- [X] Get Gamestate
- [X] Create New Game
  [[file:tictactoe/src/server/main.ts::// TODO Create]]
  #+begin_quote
Error: Failed query: insert into "tabGames" ("gameID", "player", "status", "winner", "board", "createdAt", "updatedAt") values ($1, default, $2, $3, $4, default, default) returning "gameID"
params: 82d03d77-8968-41d7-8bba-24faae891194,ongoing,,[["-","-","-"],["-","-","-"],["-","-","-"]]
at queryWithCache (/var/home/kwalerie/Documents/org/30-fractal/tictactoe/tictactoe/node_modules/drizzle-orm/pg-core/session.js:41:19)
at processTicksAndRejections (native:7:39)
  #+end_quote

What ain't working:
- [ ] Add new Move
  [[file:tictactoe/src/server/main.ts::// TODO Move]]
  addMove is not exported.
