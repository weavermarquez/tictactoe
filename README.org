...
- [ ] Install Drizzle + a Postgres driver (e.g., postgres.js or node-postgres). Connect with SSL and (ideally) the pooled connection (pgBouncer) in Supabase.
